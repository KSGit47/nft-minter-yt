...
function Dashboard() {
    ...
    const onSubmit=async(e)=>
    {
        ...
        try{
            ...
            ( async ()=>  await file2.saveIPFS())();
           (async ()=> const metadataurl=file2.ipfs();
            const conteact=new web3.eth.Contract(contractABI,contractAddress);
            const response=await contract.methods.mint(metadataurl).send({from:userAgent.get('ethAddress')});
